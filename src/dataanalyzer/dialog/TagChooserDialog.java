...
public class TagChooserDialog extends javax.swing.JDialog {
    ...
    ArrayList<Lap> lapBreaker;
    //stores the static markers
    private CategoricalHashTable<CategorizedValueMarker> staticMarkers;
    
    //arrays we will be returning
    ArrayList<String> tagsToReturn;
    ArrayList<Integer> lapsToReturn;
    ...
    public TagChooserDialog(java.awt.Frame parent, CategoricalHashMap dataMap, ArrayList<Lap> lapBreaker, CategoricalHashTable<CategorizedValueMarker> staticMarkers, ArrayList<String> tagsToReturn, ArrayList<Integer> lapsToReturn) {
        super(parent, true);
        initComponents();
        this.tagsToReturn = tagsToReturn;
        this.lapsToReturn = lapsToReturn;
    ...
    private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
        ...
        if(chosenTags != null) {
            ...
            if(chosenLaps != null) {
                for(int lap : chosenLaps)
                    lapsToReturn.add(lap);
            }

            running = false;
            this.dispose();
        } else {
            Toast.makeToast(this.getParent(), "Please select laps, or press cancel", Toast.DURATION_LONG);
        }
                    ...
                    if(categoryList.getSelectedIndex() != -1) {
                        ...
                        for(String s : selectedCategory) {
                            ...
                            for(String tag : cat.TAG) {
                                if(dataMap.getTags().contains(tag) && !compatibleTags.contains(tag))
